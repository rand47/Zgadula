...
namespace Zgadula
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Zgadnij wylosowaną liczbę z przedziału od 1 do 100.");
            ...
            while(!correctAnswer)
            {
                ...
                if (!isNumber)
                {
                    PrintColorMessage(ConsoleColor.Yellow, "Prosze wprowadzić liczbę.");
                    continue;
                }
